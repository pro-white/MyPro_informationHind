...
public class ControllerHindImageRecoAKSGS20192 {
    ...
    @FXML
    void tobuttHuiSecret(ActionEvent event) {
    ...
    @FXML
    void HFtoImageSave(ActionEvent event) {

    }

    @FXML
    void HFtoImageSaveYJ(ActionEvent event) {

    }

    @FXML
    void HFcarrierSaveYJ(ActionEvent event) {

    }

    @FXML
    void HFcarrierSave(ActionEvent event) {
